...
hist(df$x, freq = FALSE, main ='Histogram of ROI Portfolio of a Share Market Trader', xlab = 'Returns (in AUD100,000)')
...
plot(data_ts[-127],data_ts[-1],main="Scatterplot Of ROI Portfolio on consecutive days",ylab='Returns (in AUD100,000)', xlab='Previous Days')
...
summary(model1)
fitted_plot(model1, "Linear Model", data_ts)
...
fitted_plot(model4, "Cyclical Model", df2)
